...
ssh -o StrictHostKeyChecking=no -t ubuntu@$(jq  -r .vsphere_underlay.networks.vsphere.management.external_gw_ip $jsonFile) '/bin/bash /home/ubuntu/tkc/tkc_destroy.sh.template'
#
# Namespace deletion
#
