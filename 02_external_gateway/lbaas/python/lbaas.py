...
# curl -X POST http://127.0.0.1:5000/api/createlbaas -d '{"vs_name":"private-vs", "app_profile":"private","count":2, "cert": "self-signed"}' -H "Content-Type: application/json"
# curl -X POST http://127.0.0.1:5000/api/createlbaas -d '{"vs_name":"public-vs", "app_profile":"public","count":1, "cert": "new-cert"}' -H "Content-Type: application/json"
# curl -X DELETE http://127.0.0.1:5000/api/deletelbaas -d '{"vs_name": "private-vs"}' -H "Content-Type: application/json"
# curl -X DELETE http://127.0.0.1:5000/api/deletelbaas -d '{"vs_name": "public-vs"}' -H "Content-Type: application/json"
